...
CREATE TABLE "conversations" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "ai_model" character varying NOT NULL, "sns_type" character varying NOT NULL, "cmd_version" character varying NOT NULL, "is_aborted" boolean NOT NULL DEFAULT false, "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP, "twitter_accounts_conversation" bigint NULL, PRIMARY KEY ("id"), CONSTRAINT "conversations_twitter_accounts_conversation" FOREIGN KEY ("twitter_accounts_conversation") REFERENCES "twitter_accounts" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
